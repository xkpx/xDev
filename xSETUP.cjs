...
const {execSync} = require('child_process');    
	...
	execSync("pnpm install -P --no-optional --ignore-scripts @sveltejs/kit@next vite@beta svelte svelte-preprocess @sveltejs/adapter-node@next svelte-adapter-deno javascript-obfuscator rollup-obfuscator express@next dotenv", { cwd: process.cwd(), detached: false, stdio: "inherit" });
